// This is the Artists page! Here you can browse, search, and filter all the awesome talent.
// If you want to add more filters or features, this is a good place to start :)
'use client';
...
export default function ArtistsPage() {
  ...
  // Initialize filters from URL params (handy for sharing links!)
  useEffect(() => {
  ...
  // When someone asks for a quote, show a toast (and maybe do more later)
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          {/* Filters Sidebar - tweak these to narrow things down */}
          ...
          {/* Main Content - where the artists show up */}
          <div className="lg:col-span-3">
            ...
            {/* Artists Grid/List - switch between grid and list view */}
